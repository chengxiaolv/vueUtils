//  参考地址 ：   https://github.com/xyxiao001/vue-cropper  
// 要使用的话  要将  main.js中注销  下面的
// 引入mockjs
// require('./mockjs/mock.js')

<template>
  <div id="app">
    <h1> 要使用的话  要将  main.js中注销  下面的   require('./mockjs/mock.js') 该插件和mock.js冲突了</h1>
      ...
      <div class="cut">
          <vue-cropper ref="cropper" :img="option.img" :output-size="option.size" :output-type="option.outputType" :info="true" :full="option.full" :can-move="option.canMove" :can-move-box="option.canMoveBox" :fixed-box="option.fixedBox" :original="option.original"
              :auto-crop="option.autoCrop" :auto-crop-width="option.autoCropWidth" :auto-crop-height="option.autoCropHeight" :center-box="option.centerBox" @real-time="realTime" :high="option.high" @img-load="imgLoad"></vue-cropper>
      </div>
